...
Future<void> _requestCameraPermission() async {
  ...
  if (!status.isGranted) {
    // Jika izin kamera belum diberikan, coba untuk meminta izin
    PermissionStatus newStatus = await Permission.camera.request();

    // Menangani jika izin ditolak atau ditangguhkan
    if (newStatus.isDenied) {
      // Tindakan jika izin ditolak
      print("Camera permission denied.");
    } else if (newStatus.isPermanentlyDenied) {
      // Tindakan jika izin ditangguhkan (permanen) dan pengguna harus mengubahnya melalui pengaturan
      print("Camera permission permanently denied. Please enable it in settings.");
      // Bisa memberi tahu pengguna untuk membuka pengaturan aplikasi
      openAppSettings();
    } else if (newStatus.isGranted) {
      // Tindakan jika izin diberikan
